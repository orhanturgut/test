...
def bullish_filter(data):
    filtered_data = [x for x in data if (
            (x['quotes']['USD']['volume_24h_change_24h'] > 1 and x['quotes']['USD']['percent_change_24h'] > 1) or (
            x['quotes']['USD']['volume_24h_change_24h'] < -1 and x['quotes']['USD'][
...
def bearish_filter(data):
    filtered_data = [x for x in data if (
            (x['quotes']['USD']['volume_24h_change_24h'] > 1 and x['quotes']['USD']['percent_change_24h'] < -1) or (
            x['quotes']['USD']['volume_24h_change_24h'] < -1 and x['quotes']['USD']['percent_change_24h'] > 1))]
    return filtered_data
